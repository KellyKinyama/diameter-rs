...
class Dictionary {
  ...
  AvpType _parseAvpType(String typeStr) {
    switch (typeStr) {
      case "UTF8String": return AvpType.utf8String;
      case "OctetString": return AvpType.octetString;
      case "Integer32": return AvpType.integer32;
      case "Integer64": return AvpType.integer64;
      case "Unsigned32": return AvpType.unsigned32;
      case "Unsigned64": return AvpType.unsigned64;
      case "Enumerated": return AvpType.enumerated;
      case "Grouped": return AvpType.grouped;
      case "DiameterIdentity": return AvpType.identity;
      case "DiameterURI": return AvpType.diameterURI;
      case "Time": return AvpType.time;
      case "Address": return AvpType.address;
      case "IPv4": return AvpType.addressIPv4;
      case "IPv6": return AvpType.addressIPv6;
      case "Float32": return AvpType.float32;
      case "Float64": return AvpType.float64;
      default: return AvpType.unknown;
    }
  }
}
